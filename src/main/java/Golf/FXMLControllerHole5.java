...
public class FXMLControllerHole5 implements Initializable   {
...
//    }
 ...
 @Override // Override the start method in the Application class
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        par=5;
        shotCount=0;
        distanceModifier=2.6;
        holeNumberDisplay=new Text("Hole #5");
        ...
        angle = 0;
        specificInitialX=214;
        specificInitialY=485;
        specificHoleX=1400;
        specificHoleY=466;
        ...
        totalOfficialDistance=new Text("Total Official Distance: 465 yards");
                ...
                if(((Path)Shape.intersect(attemptLine, hole)).getElements().size() > 0){
                    ...
                    nextShotBt.setOnAction(new EventHandler<ActionEvent>(){
                        ...
                        public void handle(ActionEvent actionEvent){
                            try{
                                boolean isCreatedHole5 = hole5Memory.createNewFile();
                                addMoney();
                            }
                            catch(IOException e){

                            }
                            try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("hole5.txt"));) {
...
//      pane.getChildren().addAll(accuracyGauge, accuracyDet);
  ...
  public void setGolfBag() throws IOException{
    ...
    public boolean onGreen(int x, int y){
        ...
        Image image=new Image("Hole5Screenshot.png", 1550, 800, false, false);
