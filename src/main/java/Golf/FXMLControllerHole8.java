...
public class FXMLControllerHole8 implements Initializable   {
...
//    }
 ...
 @Override // Override the start method in the Application class
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        par=4;
        shotCount=0;
        distanceModifier=3.67;
        holeNumberDisplay=new Text("Hole #8");
        ...
        angle = 0;
        specificInitialX=165;
        specificInitialY=218;
        specificHoleX=1354;
        specificHoleY=313;
        ...
        totalOfficialDistance=new Text("Total Official Distance: 453 yards");
                ...
                if(((Path)Shape.intersect(attemptLine, hole)).getElements().size() > 0){
                    ...
                    nextShotBt.setOnAction(new EventHandler<ActionEvent>(){
                        ...
                        public void handle(ActionEvent actionEvent){
                            try{
                                boolean isCreatedHole8 = hole8Memory.createNewFile();
                                addMoney();
                            }
                            catch(IOException e){

                            }
                            try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("hole8.txt"));) {
...
//      pane.getChildren().addAll(accuracyGauge, accuracyDet);
  ...
  public void setGolfBag() throws IOException{
    ...
    public boolean onGreen(int x, int y){
        ...
        Image image=new Image("Hole8Screenshot.png", 1550, 800, false, false);
