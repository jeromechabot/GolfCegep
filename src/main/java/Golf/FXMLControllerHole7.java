...
public class FXMLControllerHole7 implements Initializable   {
...
//    }
 ...
 @Override // Override the start method in the Application class
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        par=4;
        shotCount=0;
        distanceModifier=2.7;
        holeNumberDisplay=new Text("Hole #7");
        ...
        totalOfficialDistance=new Text("Total Official Distance: 495 yards");
                ...
                if(((Path)Shape.intersect(attemptLine, hole)).getElements().size() > 0){
                    ...
                    nextShotBt.setOnAction(new EventHandler<ActionEvent>(){
                        ...
                        public void handle(ActionEvent actionEvent){
                            try{
                                boolean isCreatedHole7 = hole7Memory.createNewFile();
                                addMoney();
                            }
                            catch(IOException e){

                            }
                            try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("hole7.txt"));) {
...
//      pane.getChildren().addAll(accuracyGauge, accuracyDet);
  ...
  public void setGolfBag() throws IOException{
    ...
    public boolean onGreen(int x, int y){
        ...
        Image image=new Image("Hole7Screenshot.png", 1550, 800, false, false);
