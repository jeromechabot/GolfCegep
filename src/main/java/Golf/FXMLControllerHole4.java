...
public class FXMLControllerHole4 implements Initializable   {
...
//    }
 ...
 @Override // Override the start method in the Application class
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        par=4;
        shotCount=0;
        distanceModifier=2.4;
        holeNumberDisplay=new Text("Hole #4");
        ...
        angle = 0;
        specificInitialX=127;
        specificInitialY=405;
        specificHoleX=1393;
        specificHoleY=433;
        ...
        totalOfficialDistance=new Text("Total Official Distance: 530 yards");
                ...
                if(((Path)Shape.intersect(attemptLine, hole)).getElements().size() > 0){
                    ...
                    nextShotBt.setOnAction(new EventHandler<ActionEvent>(){
                        ...
                        public void handle(ActionEvent actionEvent){
                            try{
                                boolean isCreatedHole4 = hole4Memory.createNewFile();
                                addMoney();
                            }
                            catch(IOException e){

                            }
                            try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("hole4.txt"));) {
...
//      pane.getChildren().addAll(accuracyGauge, accuracyDet);
  ...
  public void setGolfBag() throws IOException{
    ...
    public boolean onGreen(int x, int y){
        ...
        Image image=new Image("Hole4Screenshot.png", 1550, 800, false, false);
