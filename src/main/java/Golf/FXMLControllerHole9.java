...
public class FXMLControllerHole9 implements Initializable   {
...
//    }
 ...
 @Override // Override the start method in the Application class
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        par=3;
        shotCount=0;
        distanceModifier=5.9;
        holeNumberDisplay=new Text("Hole #9");
        ...
        angle = 0;
        specificInitialX=222;
        specificInitialY=400;
        specificHoleX=1177;
        specificHoleY=397;
        ...
        totalOfficialDistance=new Text("Total Official Distance: 160 yards");
                ...
                if(((Path)Shape.intersect(attemptLine, hole)).getElements().size() > 0){
                    ...
                    nextShotBt.setOnAction(new EventHandler<ActionEvent>(){
                        ...
                        public void handle(ActionEvent actionEvent){
                            try{
                                boolean isCreatedHole9 = hole9Memory.createNewFile();
                                addMoney();
                            }
                            catch(IOException e){

                            }
                            try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("hole9.txt"));) {
...
//      pane.getChildren().addAll(accuracyGauge, accuracyDet);
  ...
  public void setGolfBag() throws IOException{
    ...
    public boolean onGreen(int x, int y){
        ...
        Image image=new Image("Hole9Screenshot.png", 1550, 800, false, false);
