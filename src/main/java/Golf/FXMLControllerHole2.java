...
public class FXMLControllerHole2 implements Initializable   {
...
//    }
 ...
 @Override // Override the start method in the Application class
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        par=5;
        shotCount=0;
        distanceModifier=2.5;
        holeNumberDisplay=new Text("Hole #2");
        ...
        angle = 0;
        specificInitialX=135;
        specificInitialY=198;
        specificHoleX=1445;
        specificHoleY=120;
        ...
        totalOfficialDistance=new Text("Total Official Distance: 575 yards");
                ...
                if(((Path)Shape.intersect(attemptLine, hole)).getElements().size() > 0){
                    ...
                    nextShotBt.setOnAction(new EventHandler<ActionEvent>(){
                        ...
                        public void handle(ActionEvent actionEvent){
                            try{
                                boolean isCreatedHole2 = hole2Memory.createNewFile();
                                addMoney();
                            }
                            catch(IOException e){

                            }
                            try (ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("hole2.txt"));) {
...
//      pane.getChildren().addAll(accuracyGauge, accuracyDet);
  ...
  public void setGolfBag() throws IOException{
    ...
    public boolean onGreen(int x, int y){
        ...
        Image image=new Image("Hole2Screenshot.png", 1550, 800, false, false);
